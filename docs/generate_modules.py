...
# https://bitbucket.org/etienned/sphinx-autopackage-script/raw/7199e9725789/generate_modules.py
# by the user Etienne Desautels. It has been modified to work with the
# Tiger Lily project, but is in no way supported or owned by that project.
# The original copyright has been preserved in accordance with the terms of the
# GPL.
