...
# -*- coding: utf-8 -*-
#
# Tiger Lily documentation build configuration file, created by
...
version,release = tigerlily.VERSION_INFO
...
htmlhelp_basename = 'TigerLilydoc'
...
texinfo_documents = [
  ('index', 'TigerLily', 'Tiger Lily Documentation', 'Erich Blume',
   'TigerLily', 'One line description of project.', 'Miscellaneous'),
]
